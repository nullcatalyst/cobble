...
class BuildSettings {
    ...
    async load(raw, filePath, fileExtProtocols = {}, release = false) {
        ...
        const knownPlatforms = KNOWN_TARGETS.reduce((settings, platformName) => ({ ...settings, [platformName]: this._target === platformName }), { 'release': release });
